...
<td colspan="3" align="left" valign="top" bgcolor="#99FFFF" style="width:190px; background:#99FFFF; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; margin-left:10px;">Original Purchasher Registration :: 
...
foreach ($row as $key => $value):
    ...
    if ($key == 'id') { continue; }
    if ($key == 'uid') { continue; }
    if ($key == 'survey_id') { $value = strtoupper(substr("00000".dechex($value*19),-5)); }
...
?>
    ...
    <td width="25%" align="left" valign="top" bgcolor="#eef0f3" style="background-color:#eef0f3; Font-family:Arial, Helvetica, sans-serif; font-size:11px; font-weight:bold; margin-left:10px; border-top:thin; border-top-color:#999; border-top-style:solid; border-left:thin; border-left-color:#999; border-left-style:solid;"><?php echo $title; ?> </td>

    <td colspan="2" align="left" valign="top" bgcolor="#eef0f3" style="height:22px; height:22px; background-color:#eef0f3; font-family:Arial, Helvetica, sans-serif; font-size:11px; margin-left:10px; border-top:thin; border-top-color:#999; border-top-style:solid; border-left:thin; border-left-color:#999; border-left-style:solid; border-right:thin; border-right-color:#999; border-right-style:solid;"><?php echo $value; ?> </td>
